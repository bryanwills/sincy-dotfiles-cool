...
set.textwidth = 80   -- move text to new line at 80 characters set.spell = true     -- Enable spell checking
...
-- Force permanent backgrounds (higher priority than theme)
-- vim.api.nvim_set_hl(0, "RenderMarkdownH1Bg", { fg = color_fg, bg = color1_bg, bold = true, default = false })
-- vim.api.nvim_set_hl(0, "RenderMarkdownH2Bg", { fg = color_fg, bg = color2_bg, bold = true, default = false })
-- vim.api.nvim_set_hl(0, "RenderMarkdownH3Bg", { fg = color_fg, bg = color3_bg, bold = true, default = false })
-- vim.api.nvim_set_hl(0, "RenderMarkdownH4Bg", { fg = color_fg, bg = color4_bg, bold = true, default = false })
-- vim.api.nvim_set_hl(0, "RenderMarkdownH5Bg", { fg = color_fg, bg = color5_bg, bold = true, default = false })
-- vim.api.nvim_set_hl(0, "RenderMarkdownH6Bg", { fg = color_fg, bg = color6_bg, bold = true, default = false })
